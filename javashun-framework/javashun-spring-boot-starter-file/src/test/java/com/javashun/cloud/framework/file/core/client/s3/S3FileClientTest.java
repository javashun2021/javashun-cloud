package com.javashun.cloud.framework.file.core.client.s3;
...
public class S3FileClientTest {
    ...
    public void testAliyun() throws Exception {
        ...
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://ali-oss.javashun.com
        // 默认北京的 endpoint
    ...
    public void testQCloud() throws Exception {
        ...
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://tengxun-oss.javashun.com
        // 默认上海的 endpoint
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.cloud.javashun.com"); // 如果有自定义域名，则可以设置。http://static.cloud.javashun.com
        // 默认上海的 endpoint
