package com.javashun.cloud.framework.pay.core.client.impl;

import cn.hutool.core.lang.Assert;
import com.javashun.cloud.framework.pay.core.client.PayClient;
import com.javashun.cloud.framework.pay.core.client.PayClientConfig;
import com.javashun.cloud.framework.pay.core.client.PayClientFactory;
import com.javashun.cloud.framework.pay.core.client.impl.alipay.AlipayPayClientConfig;
import com.javashun.cloud.framework.pay.core.client.impl.alipay.AlipayPcPayClient;
import com.javashun.cloud.framework.pay.core.client.impl.alipay.AlipayQrPayClient;
import com.javashun.cloud.framework.pay.core.client.impl.alipay.AlipayWapPayClient;
import com.javashun.cloud.framework.pay.core.client.impl.wx.WXLitePayClient;
import com.javashun.cloud.framework.pay.core.client.impl.wx.WXNativePayClient;
import com.javashun.cloud.framework.pay.core.client.impl.wx.WXPayClientConfig;
import com.javashun.cloud.framework.pay.core.client.impl.wx.WXPubPayClient;
import com.javashun.cloud.framework.pay.core.enums.PayChannelEnum;
...
public class PayClientFactoryImpl implements PayClientFactory {
    ...
    private <Config extends PayClientConfig> AbstractPayClient<Config> createPayClient(
        ...
        // 创建客户端
        // TODO @javier WX_LITE WX_APP 如果不添加在 项目启动的时候去初始化会报错无法启动。所以我手动加了两个，具体需要你来配
        switch (channelEnum) {
