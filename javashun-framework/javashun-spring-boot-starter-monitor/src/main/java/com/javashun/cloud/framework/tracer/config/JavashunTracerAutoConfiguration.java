...
import com.javashun.cloud.framework.tracer.core.aop.BizTraceAspect;
import com.javashun.cloud.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "javashun.tracer", value = "enable", matchIfMissing = true)
public class JavashunTracerAutoConfiguration {
