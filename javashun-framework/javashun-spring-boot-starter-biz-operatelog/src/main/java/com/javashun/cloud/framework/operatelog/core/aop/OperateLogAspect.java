package com.javashun.cloud.framework.operatelog.core.aop;
...
import com.javashun.cloud.framework.operatelog.core.enums.OperateTypeEnum;
import com.javashun.cloud.framework.operatelog.core.service.OperateLog;
import com.javashun.cloud.framework.operatelog.core.service.OperateLogFrameworkService;
import com.javashun.cloud.framework.web.core.util.WebFrameworkUtils;
...
import static com.javashun.cloud.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.javashun.cloud.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.javashun.cloud.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.javashun.cloud.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.javashun.cloud.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.javashun.cloud.framework.operatelog.core.annotations.OperateLog operateLog,
