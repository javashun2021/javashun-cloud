package com.javashun.cloud.gateway.util;

import cn.hutool.core.map.MapUtil;
import com.javashun.cloud.framework.common.util.json.JsonUtils;
import com.javashun.cloud.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from javashun-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 */
