package com.javashun.cloud.gateway.handler;

import com.javashun.cloud.framework.common.pojo.CommonResult;
import com.javashun.cloud.gateway.util.WebFrameworkUtils;
 ...
 *
 * 在功能上，和 javashun-spring-boot-starter-web 的 GlobalExceptionHandler 类是一致的
 */
@Component
...
public class GlobalExceptionHandler implements ErrorWebExceptionHandler {
    ...
    private CommonResult<?> responseStatusExceptionHandler(ServerWebExchange exchange,
        ...
        // TODO javier：这里要精细化翻译，默认返回用户是看不懂的
