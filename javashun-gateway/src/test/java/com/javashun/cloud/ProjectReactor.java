...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.javashun.cloud";
    private static final String ARTIFACT_ID = "javashun";
    private static final String PACKAGE_NAME = "com.javashun.cloud";
    private static final String TITLE = "javashun管理系统";
