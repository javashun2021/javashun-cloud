package com.javashun.cloud.module.infra.service.file;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.javashun.cloud.framework.common.pojo.PageResult;
import com.javashun.cloud.framework.file.core.client.FileClient;
import com.javashun.cloud.framework.file.core.client.FileClientConfig;
import com.javashun.cloud.framework.file.core.client.FileClientFactory;
import com.javashun.cloud.framework.file.core.client.local.LocalFileClient;
import com.javashun.cloud.framework.file.core.client.local.LocalFileClientConfig;
import com.javashun.cloud.framework.file.core.enums.FileStorageEnum;
...
import com.javashun.cloud.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
...
import com.javashun.cloud.module.infra.dal.mysql.file.FileConfigMapper;
import com.javashun.cloud.module.infra.mq.producer.file.FileConfigProducer;
...
import static com.javashun.cloud.framework.test.core.util.RandomUtils.randomLongId;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        ...
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai")
                .put("domain", "https://www.javashun.com").build();
        ...
        assertEquals("https://www.javashun.com", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // verify 调用
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/yunai").setDomain("https://www.javashun.com")));
        ...
        FileConfigUpdateReqVO reqVO = randomPojo(FileConfigUpdateReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai2")
                    .put("domain", "https://doc.javashun.com").build();
            o.setConfig(config);
        });
        ...
        assertEquals("https://doc.javashun.com", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // verify 调用
        verify(fileConfigProducer).sendFileConfigRefreshMessage();
    }
    ...
    public void testGetFileConfigPage() {
       // mock 数据
       FileConfigDO dbFileConfig = randomFileConfigDO().setName("javashun")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://www.javashun.com");

        // 调用，并断言
        assertEquals("https://www.javashun.com", fileConfigService.testFileConfig(id));
    }
