package com.javashun.cloud.module.infra.service.logger;
...
import com.javashun.cloud.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import com.javashun.cloud.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.javashun.cloud.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.javashun.cloud.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.javashun.cloud.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("javashun-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("javashun-test");
