package com.javashun.cloud.module.infra.service.codegen.inner;
...
import com.javashun.cloud.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "javashun-module-${table.moduleName}/" + // 顶级模块
                "javashun-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "javashun-module-${table.moduleName}/" + // 顶级模块
                "javashun-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "javashun-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "javashun-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
