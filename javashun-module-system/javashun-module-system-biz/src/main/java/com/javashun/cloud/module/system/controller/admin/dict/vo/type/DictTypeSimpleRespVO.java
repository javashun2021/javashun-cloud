package com.javashun.cloud.module.system.controller.admin.dict.vo.type;
...
public class DictTypeSimpleRespVO {
    ...
    @Schema(description = "字典类型名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "javashun")
    private String name;
