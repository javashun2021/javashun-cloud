package com.javashun.cloud.module.system.controller.admin.oauth2.vo.client;
...
public class OAuth2ClientBaseVO {
    ...
    @Schema(description = "应用图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.javashun.com/xx.png")
    ...
    @Schema(description = "可重定向的 URI 地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.javashun.cn")
