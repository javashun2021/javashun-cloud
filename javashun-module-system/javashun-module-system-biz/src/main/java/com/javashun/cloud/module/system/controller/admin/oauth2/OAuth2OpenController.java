...
import com.javashun.cloud.framework.common.util.http.HttpUtils;
...
import com.javashun.cloud.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.javashun.cloud.module.system.util.oauth2.OAuth2Utils;
...
import static com.javashun.cloud.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.javashun.cloud.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static com.javashun.cloud.framework.common.pojo.CommonResult.success;
import static com.javashun.cloud.framework.common.util.collection.CollectionUtils.convertList;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.javashun.com"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.javashun.com"),
