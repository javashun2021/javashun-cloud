package com.javashun.cloud.module.system.controller.admin.user;

import cn.hutool.core.collection.CollUtil;
import com.javashun.cloud.module.system.controller.admin.user.vo.user.*;
import com.javashun.cloud.module.system.convert.user.UserConvert;
...
import com.javashun.cloud.framework.excel.core.util.ExcelUtils;
...
import static com.javashun.cloud.framework.operatelog.core.enums.OperateTypeEnum.EXPORT;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("yunai").deptId(1L).email("yunai@javashun.com").mobile("15601691300")
                        .nickname("javier").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("javashun").deptId(2L).email("yuanma@javashun.com").mobile("15601701300")
                        .nickname("javier").status(CommonStatusEnum.DISABLE.getStatus()).sex(SexEnum.FEMALE.getSex()).build()
        );
