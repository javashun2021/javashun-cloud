package com.javashun.cloud.module.system.controller.admin.notify.vo.message;
...
public class NotifyMessageBaseVO {
    ...
    @Schema(description = "模版发送人名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "javier")
