package com.javashun.cloud.module.system.controller.admin.permission.vo.role;
...
public class RoleExportReqVO {
    ...
    @Schema(description = "角色名称，模糊匹配", example = "javashun")
    private String name;

    @Schema(description = "角色标识，模糊匹配", example = "javashun")
    private String code;
