...
import com.javashun.cloud.framework.common.util.monitor.TracerUtils;
import com.javashun.cloud.framework.common.util.servlet.ServletUtils;
import com.javashun.cloud.framework.common.util.validation.ValidationUtils;
...
import com.javashun.cloud.module.system.convert.auth.AuthConvert;
...
import com.javashun.cloud.module.system.enums.oauth2.OAuth2ClientConstants;
...
public class AdminAuthServiceImpl implements AdminAuthService {
     ...
     * 验证码的开关，默认为 true
     */
    @Value("${javashun.captcha.enable:true}")
