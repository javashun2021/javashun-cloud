...
import com.javashun.cloud.framework.common.util.date.DateUtils;
...
import com.javashun.cloud.module.system.controller.admin.permission.vo.role.RoleCreateReqVO;
...
import com.javashun.cloud.module.system.convert.tenant.TenantConvert;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 javashun.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
    ...
    public void validTenant(Long id) {
        ...
        if (tenant.getStatus().equals(CommonStatusEnum.DISABLE.getStatus())) {
            throw exception(ErrorCodeConstants.TENANT_DISABLE, tenant.getName());
        }
        if (DateUtils.isExpired(tenant.getExpireTime())) {
            throw exception(ErrorCodeConstants.TENANT_EXPIRE, tenant.getName());
        }
    }
