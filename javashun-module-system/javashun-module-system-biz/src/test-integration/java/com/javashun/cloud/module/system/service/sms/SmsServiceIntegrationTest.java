...
import com.javashun.cloud.framework.sms.config.JavashunSmsAutoConfiguration;
import com.javashun.cloud.module.system.test.BaseDbAndRedisIntegrationTest;
import com.javashun.cloud.module.system.mq.consumer.sms.SmsSendConsumer;
...
// TODO ：需要迁移
@Import({JavashunSmsAutoConfiguration.class,
