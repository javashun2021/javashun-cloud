package com.javashun.cloud.module.system.service.sms;
...
import com.javashun.cloud.framework.sms.core.client.SmsClient;
import com.javashun.cloud.framework.sms.core.client.SmsClientFactory;
import com.javashun.cloud.framework.sms.core.client.SmsCommonResult;
import com.javashun.cloud.framework.sms.core.client.dto.SmsTemplateRespDTO;
...
import com.javashun.cloud.module.system.controller.admin.sms.vo.template.SmsTemplateExportReqVO;
import com.javashun.cloud.module.system.controller.admin.sms.vo.template.SmsTemplatePageReqVO;
...
import com.javashun.cloud.module.system.dal.mysql.sms.SmsTemplateMapper;
import com.javashun.cloud.module.system.enums.sms.SmsTemplateTypeEnum;
import com.javashun.cloud.module.system.mq.producer.sms.SmsProducer;
...
public class SmsTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateSmsTemplate_success() {
        ...
        SmsTemplateCreateReqVO reqVO = randomPojo(SmsTemplateCreateReqVO.class, o -> {
            ...
            o.setType(RandomUtil.randomEle(SmsTemplateTypeEnum.values()).getType()); // 保证 type 的 范围
        });
        // mock Channel 的方法
