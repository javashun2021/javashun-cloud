package com.javashun.cloud.module.system.controller.admin.oauth2;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.javashun.cloud.framework.common.core.KeyValue;
import com.javashun.cloud.framework.common.enums.UserTypeEnum;
...
import com.javashun.cloud.framework.common.util.collection.SetUtils;
import com.javashun.cloud.framework.common.util.object.ObjectUtils;
import com.javashun.cloud.framework.test.core.ut.BaseMockitoUnitTest;
import com.javashun.cloud.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.javashun.cloud.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.javashun.cloud.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.javashun.cloud.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.javashun.cloud.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.javashun.cloud.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.javashun.cloud.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.javashun.cloud.module.system.service.oauth2.OAuth2ApproveService;
import com.javashun.cloud.module.system.service.oauth2.OAuth2ClientService;
import com.javashun.cloud.module.system.service.oauth2.OAuth2GrantService;
import com.javashun.cloud.module.system.service.oauth2.OAuth2TokenService;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_ApproveNo() {
        ...
        String clientId = randomString();
        String scope = "{\"read\": true, \"write\": false}";
        String redirectUri = "https://www.javashun.com";
        String state = "test";
        // mock 方法
        OAuth2ClientDO client = randomPojo(OAuth2ClientDO.class);
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.javashun.com#error=access_denied&error_description=User%20denied%20access&state=test", result.getData());
    }
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.javashun.com#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read", result.getData());
    }
    ...
    public void testApproveOrDeny_approveWithCode() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.javashun.com?code=test_code&state=test", result.getData());
    }
