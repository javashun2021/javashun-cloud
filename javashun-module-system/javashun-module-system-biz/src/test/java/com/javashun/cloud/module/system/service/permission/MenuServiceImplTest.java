...
import com.javashun.cloud.module.system.controller.admin.permission.vo.menu.MenuCreateReqVO;
import com.javashun.cloud.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import com.javashun.cloud.module.system.controller.admin.permission.vo.menu.MenuUpdateReqVO;
import com.javashun.cloud.module.system.dal.dataobject.permission.MenuDO;
import com.javashun.cloud.module.system.dal.mysql.permission.MenuMapper;
import com.javashun.cloud.module.system.enums.permission.MenuTypeEnum;
import com.javashun.cloud.module.system.mq.producer.permission.MenuProducer;
...
import static com.javashun.cloud.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("javier").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
