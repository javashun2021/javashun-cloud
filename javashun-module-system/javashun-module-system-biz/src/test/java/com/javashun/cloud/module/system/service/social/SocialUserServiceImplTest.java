package com.javashun.cloud.module.system.service.social;
...
import com.javashun.cloud.module.system.dal.dataobject.social.SocialUserBindDO;
import com.javashun.cloud.module.system.dal.dataobject.social.SocialUserDO;
import com.javashun.cloud.module.system.dal.mysql.social.SocialUserBindMapper;
import com.javashun.cloud.module.system.dal.mysql.social.SocialUserMapper;
...
import static com.javashun.cloud.module.system.enums.ErrorCodeConstants.SOCIAL_USER_AUTH_FAILURE;
import static com.javashun.cloud.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImplTest extends BaseDbAndRedisUnitTest {
    ...
    @MockBean
    private JavashunAuthRequestFactory authRequestFactory;
    ...
    public void testGetAuthorizeUrl() {
        try (MockedStatic<AuthStateUtils> authStateUtilsMock = mockStatic(AuthStateUtils.class)) {
            ...
            when(authRequest.authorize(eq("aoteman"))).thenReturn("https://www.javashun.com?redirect_uri=yyy");

            // 调用
            String url = socialUserService.getAuthorizeUrl(type, redirectUri);
            // 断言
            assertEquals("https://www.javashun.com?redirect_uri=sss", url);
        }
    }
