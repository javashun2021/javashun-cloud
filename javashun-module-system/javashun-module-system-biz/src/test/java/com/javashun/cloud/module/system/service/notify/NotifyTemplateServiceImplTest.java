package com.javashun.cloud.module.system.service.notify;
...
import com.javashun.cloud.module.system.controller.admin.notify.vo.template.NotifyTemplateCreateReqVO;
import com.javashun.cloud.module.system.controller.admin.notify.vo.template.NotifyTemplatePageReqVO;
import com.javashun.cloud.module.system.controller.admin.notify.vo.template.NotifyTemplateUpdateReqVO;
import com.javashun.cloud.module.system.dal.dataobject.notify.NotifyTemplateDO;
import com.javashun.cloud.module.system.dal.mysql.notify.NotifyTemplateMapper;
import com.javashun.cloud.module.system.mq.producer.notify.NotifyProducer;
...
public class NotifyTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateNotifyTemplate_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> notifyTemplateService.updateNotifyTemplate(reqVO), ErrorCodeConstants.NOTIFY_TEMPLATE_NOT_EXISTS);
    }
    ...
    public void testDeleteNotifyTemplate_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> notifyTemplateService.deleteNotifyTemplate(id), ErrorCodeConstants.NOTIFY_TEMPLATE_NOT_EXISTS);
    }
