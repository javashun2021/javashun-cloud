...
import com.javashun.cloud.module.system.controller.admin.sms.vo.log.SmsLogExportReqVO;
import com.javashun.cloud.module.system.controller.admin.sms.vo.log.SmsLogPageReqVO;
import com.javashun.cloud.module.system.dal.dataobject.sms.SmsLogDO;
import com.javashun.cloud.module.system.dal.dataobject.sms.SmsTemplateDO;
import com.javashun.cloud.module.system.dal.mysql.sms.SmsLogMapper;
import com.javashun.cloud.module.system.enums.sms.SmsReceiveStatusEnum;
import com.javashun.cloud.module.system.enums.sms.SmsSendStatusEnum;
...
public class SmsLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateSmsLog() {
        ...
        SmsTemplateDO templateDO = randomPojo(SmsTemplateDO.class,
                o -> o.setType(RandomUtil.randomEle(SmsTemplateTypeEnum.values()).getType()));
