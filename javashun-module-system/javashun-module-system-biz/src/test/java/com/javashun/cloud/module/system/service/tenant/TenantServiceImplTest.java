package com.javashun.cloud.module.system.service.tenant;
...
import com.javashun.cloud.framework.tenant.config.TenantProperties;
import com.javashun.cloud.framework.tenant.core.context.TenantContextHolder;
import com.javashun.cloud.framework.test.core.ut.BaseDbUnitTest;
import com.javashun.cloud.module.system.controller.admin.tenant.vo.tenant.TenantCreateReqVO;
import com.javashun.cloud.module.system.controller.admin.tenant.vo.tenant.TenantExportReqVO;
import com.javashun.cloud.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
...
import com.javashun.cloud.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.javashun.cloud.module.system.dal.mysql.tenant.TenantMapper;
import com.javashun.cloud.module.system.enums.permission.RoleCodeEnum;
import com.javashun.cloud.module.system.enums.permission.RoleTypeEnum;
import com.javashun.cloud.module.system.service.permission.MenuService;
import com.javashun.cloud.module.system.service.permission.PermissionService;
import com.javashun.cloud.module.system.service.permission.RoleService;
import com.javashun.cloud.module.system.service.tenant.handler.TenantInfoHandler;
import com.javashun.cloud.module.system.service.tenant.handler.TenantMenuHandler;
import com.javashun.cloud.module.system.service.user.AdminUserService;
...
import static com.javashun.cloud.framework.common.util.collection.SetUtils.asSet;
...
import static com.javashun.cloud.framework.test.core.util.RandomUtils.*;
import static com.javashun.cloud.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static com.javashun.cloud.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("javashun", user.getNickname());
        ...
        TenantCreateReqVO reqVO = randomPojo(TenantCreateReqVO.class, o -> {
            o.setContactName("javashun");
            o.setContactMobile("15601691300");
            o.setPackageId(100L);
            o.setStatus(randomCommonStatus());
            o.setDomain("https://www.javashun.com");
            o.setUsername("yunai");
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("javashun"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("javashun");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
