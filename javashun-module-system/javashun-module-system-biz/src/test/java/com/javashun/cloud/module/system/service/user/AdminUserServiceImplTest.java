package com.javashun.cloud.module.system.service.user;
...
import com.javashun.cloud.module.system.dal.dataobject.dept.UserPostDO;
...
import com.javashun.cloud.module.system.dal.mysql.dept.UserPostMapper;
import com.javashun.cloud.module.system.dal.mysql.user.AdminUserMapper;
import com.javashun.cloud.module.system.enums.common.SexEnum;
import com.javashun.cloud.module.system.service.dept.DeptService;
import com.javashun.cloud.module.system.service.dept.PostService;
import com.javashun.cloud.module.system.service.permission.PermissionService;
import com.javashun.cloud.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("javashun");
        ...
        assertEquals("javashun", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("javashun"))).thenReturn("java");
