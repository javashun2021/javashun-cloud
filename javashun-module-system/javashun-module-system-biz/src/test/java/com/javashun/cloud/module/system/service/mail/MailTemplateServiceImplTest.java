package com.javashun.cloud.module.system.service.mail;
...
import com.javashun.cloud.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
...
import com.javashun.cloud.module.system.dal.mysql.mail.MailTemplateMapper;
import com.javashun.cloud.module.system.mq.producer.mail.MailProducer;
...
import static com.javashun.cloud.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
       ...
       // 测试 name 不匹配
       mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("javashun")));
       // 测试 code 不匹配
