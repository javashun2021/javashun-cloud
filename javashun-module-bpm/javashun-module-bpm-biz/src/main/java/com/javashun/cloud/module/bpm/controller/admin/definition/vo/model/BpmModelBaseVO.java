package com.javashun.cloud.module.bpm.controller.admin.definition.vo.model;
...
public class BpmModelBaseVO {
    ...
    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "process_javashun")
    @NotEmpty(message = "流程标识不能为空")
    private String key;

    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "javashun")
