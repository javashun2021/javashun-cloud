package com.javashun.cloud.module.bpm.controller.admin.task.vo.task;
...
public class BpmTaskTodoPageItemRespVO {
    ...
    @Schema(description = "任务名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "javashun")
    private String name;
    ...
    public static class ProcessInstance {
        ...
        @Schema(description = "流程实例名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "javashun")
        private String name;

        @Schema(description = "发起人的用户编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1024")
        private Long startUserId;

        @Schema(description = "发起人的用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "javier")
