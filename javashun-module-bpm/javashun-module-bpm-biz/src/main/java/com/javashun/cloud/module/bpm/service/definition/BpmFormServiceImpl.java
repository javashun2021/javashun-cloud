...
import com.javashun.cloud.module.bpm.convert.definition.BpmFormConvert;
...
import com.javashun.cloud.module.bpm.enums.ErrorCodeConstants;
import com.javashun.cloud.module.bpm.enums.definition.BpmModelFormTypeEnum;
import com.javashun.cloud.module.bpm.service.definition.dto.BpmFormFieldRespDTO;
import com.javashun.cloud.module.bpm.service.definition.dto.BpmModelMetaInfoRespDTO;
...
import static com.javashun.cloud.module.bpm.enums.ErrorCodeConstants.MODEL_DEPLOY_FAIL_FORM_NOT_CONFIG;
...
public class BpmFormServiceImpl implements BpmFormService {
    ...
    private void checkFields(List<String> fields) {
        if (true) { // TODO javier：兼容 Vue3 工作流：因为采用了新的表单设计器，所以暂时不校验
            return;
        }
