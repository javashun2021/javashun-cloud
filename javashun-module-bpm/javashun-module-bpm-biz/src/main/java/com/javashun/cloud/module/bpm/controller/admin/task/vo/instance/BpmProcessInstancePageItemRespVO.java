package com.javashun.cloud.module.bpm.controller.admin.task.vo.instance;
...
public class BpmProcessInstancePageItemRespVO {
    ...
    public static class Task {
        ...
        @Schema(description = "任务名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "javashun")
        private String name;
