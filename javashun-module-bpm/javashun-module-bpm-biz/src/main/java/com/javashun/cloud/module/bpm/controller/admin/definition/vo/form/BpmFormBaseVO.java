package com.javashun.cloud.module.bpm.controller.admin.definition.vo.form;
...
public class BpmFormBaseVO {
    ...
    @Schema(description = "表单名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "javashun")
