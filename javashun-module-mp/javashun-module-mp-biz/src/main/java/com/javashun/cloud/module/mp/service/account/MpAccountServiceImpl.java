package com.javashun.cloud.module.mp.service.account;
...
import com.javashun.cloud.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.javashun.cloud.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.javashun.cloud.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.javashun.cloud.module.mp.convert.account.MpAccountConvert;
import com.javashun.cloud.module.mp.dal.dataobject.account.MpAccountDO;
import com.javashun.cloud.module.mp.dal.mysql.account.MpAccountMapper;
import com.javashun.cloud.module.mp.enums.ErrorCodeConstants;
...
import static com.javashun.cloud.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.javashun.cloud.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 javashun-module-mp - 表结构未导入][参考 https://doc.javashun.com/mp/build/ 开启]");
            }
