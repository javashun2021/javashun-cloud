package com.javashun.cloud.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.StrUtil;
import com.javashun.cloud.framework.common.pojo.PageResult;
import com.javashun.cloud.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.javashun.cloud.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.javashun.cloud.module.mp.convert.message.MpMessageConvert;
import com.javashun.cloud.module.mp.dal.dataobject.account.MpAccountDO;
import com.javashun.cloud.module.mp.dal.dataobject.message.MpMessageDO;
import com.javashun.cloud.module.mp.dal.dataobject.user.MpUserDO;
import com.javashun.cloud.module.mp.dal.mysql.message.MpMessageMapper;
import com.javashun.cloud.module.mp.enums.message.MpMessageSendFromEnum;
import com.javashun.cloud.module.mp.framework.mp.core.MpServiceFactory;
import com.javashun.cloud.module.mp.framework.mp.core.util.MpUtils;
import com.javashun.cloud.module.mp.service.account.MpAccountService;
import com.javashun.cloud.module.mp.service.material.MpMaterialService;
import com.javashun.cloud.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.javashun.cloud.module.mp.service.user.MpUserService;
...
import static com.javashun.cloud.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
