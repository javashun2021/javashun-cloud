package com.javashun.cloud.module.mp.controller.admin.menu.vo;
...
import static com.javashun.cloud.module.mp.framework.mp.core.util.MpUtils.*;
...
public class MpMenuBaseVO {
    ...
    @Schema(description = "网页链接", example = "https://www.javashun.com/")
