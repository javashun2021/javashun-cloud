package com.javashun.cloud.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.javashun.cloud.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
